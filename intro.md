...
Ready to write your first Python program? Head to [Chapter 1: Getting Started with Python](chapters/01_getting_started.md).
...
Looking for the **Statistics & Quantitative Methods** version of this book? <a href="stats/intro_stats.html">Click here</a>.
```
